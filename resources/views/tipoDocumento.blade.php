...
<div class="contenedor-general">
    ...
    <h1 class="vista-titulo">Tipos de Documentos</h1>
    <form action="{{ route('tipoDocumentos.store') }}" method="post" autocomplete="off">
        @csrf



        <div class="contenedor-agregar-cliente">
            <p class="titulo-tarjeta-agregar">Nuevo Tipo de Documento</p>
        ...
        <div class="todos-lista">
            @foreach ($tipoDocumentos as $tipoDocumento)
                <div class="linea-listas">
                    ...
                    <a class="editar-listas" href="{{ route('tipoDocumentos.edit', $tipoDocumento->id) }}">
                        <p>Editar</p>
                    </a>
                </div>
            @endforeach
